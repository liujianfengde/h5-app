package cn.liuxiaoer.webview.netinfo;
...
public class NetInfoModule {
    ...
    public NetInfoModule(Application context) {
    ...
    private void registerReceiver() {
        ...
        context.getApplicationContext().registerReceiver(mConnectivityBroadcastReceiver, filter);
    ...
    private void unregisterReceiver() {
        if (mConnectivityBroadcastReceiver.isRegistered()) {
            context.getApplicationContext().unregisterReceiver(mConnectivityBroadcastReceiver);
